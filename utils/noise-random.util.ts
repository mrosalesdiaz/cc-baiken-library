...
export default class NoiseRandom {



    perlin_octaves: number = 4; // default to medium smooth
    perlin_amp_falloff: number = 0.5; // 50% reduction/octave



    perlin: any[]; // will be initialized lazily by noise() or noiseSeed()
